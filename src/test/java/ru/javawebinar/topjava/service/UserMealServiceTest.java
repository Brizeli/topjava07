...
import ru.javawebinar.topjava.service.datajpa.DataJpaUserMealServiceTest;
...
public abstract class UserMealServiceTest extends DbTest {
    ...
    public void testGetWithUser(){
        UserMeal mealWithUser = service.getWithUser(MEAL1_ID, USER_ID);
        UserTestData.MATCHER.assertEquals(USER,mealWithUser.getUser());
    }
}